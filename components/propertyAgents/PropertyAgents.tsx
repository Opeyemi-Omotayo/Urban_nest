...
const PropertyAgents = () => {
  return (
    <>
    <section className="flex items-center justify-center flex-col mt-[4rem] mb-[4rem]" data-aos="fade-up">
    <h1 className="mb-4 text-3xl font-bold">Property Agents</h1>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 mt-10 lg:grid-cols-4 gap-6 overflow-hidden px-12 lg:px-[8rem] 2xl:px-[22rem] ">
            <Card />
      </section>
      </>
  )
